...
const navigation = [
  { name: "Programmes", href: "/admin", regex: "^/admin$", showInNav: true },
  {
    name: "Exercises",
    href: "/admin/exercises",
    regex: "^/admin/exercises$",
    showInNav: true,
  },
  {
    name: "Edit Exercise",
    href: "/admin/exercises/edit",
    regex: "/admin/exercises/edit/[a-z|0-9|-]",
    showInNav: false,
  },
  {
    name: "Edit Programme",
    href: "/admin/programmes/edit",
    regex: "/admin/programmes/edit/[a-z|0-9|-]",
    showInNav: false,
  },
  {
    name: "Create Exercise",
    href: "/admin/exercises/create",
    regex: "/admin/exercises/create",
    showInNav: false,
  },
  {
    name: "Create Programme",
    href: "/admin/programmes/create",
    regex: "/admin/programmes/create",
    showInNav: false,
  },
];

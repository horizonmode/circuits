...
//         public static IActionResult DuplicateProgramme([HttpTrigger(methods: "get", Route = "programme/duplicate/{id}")] HttpRequest req,
//         [CosmosDB(
//                 databaseName: "screens",
//                 containerName: "programmes",
//                 Id = "{id}",
...
//                 databaseName: "screens",
//                 containerName: "programmes",
//                 Connection = "CosmosDBConnection")] out Programme duplicateProgramme, ILogger log)
//         {
//             log.LogInformation($"Duplicate Programme function processed");


//             duplicateProgramme = programme.Copy();

//             return new OkObjectResult(duplicateProgramme);
//         }
